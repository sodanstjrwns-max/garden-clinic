...
export const Head: FC<LayoutProps> = ({ title, description, path, ogType = 'website', jsonLd, keywords, ogImage, noindex }) => {
  ...
  return (
    <head>
      ...
      />
      <link rel="stylesheet" href="/static/style.css?v=20260912-r22" />
    ...
    <script dangerouslySetInnerHTML={{ __html: '(function(c,l,a,r,i,t,y){c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i;y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);})(window,document,"clarity","script","yc80zk1t9o");' }} />
    ...
    <header class="site-header">
      <div class="wrap site-header__inner">
        <a href="/" class="logo" aria-label="정원한의원 오산 홈">
          <span class="logo__mark">
            <img class="logo__mark-dark" src="/static/img/logo-symbol.webp" alt="정원한의원 심볼" width="30" height="44" />
            <img class="logo__mark-light" src="/static/img/logo-symbol-white.webp" alt="" width="30" height="44" aria-hidden="true" />
          </span>
      ...
      <div class="mobile-menu">
        <div class="mobile-menu__top">
          <span class="logo"><span class="logo__mark"><img src="/static/img/logo-symbol-white.webp" alt="정원한의원 심볼" width="30" height="44" /></span><span class="logo__name">정원한의원</span></span>
      ...
      <div class="wrap">
        <div class="footer-top">
          <div class="footer-brand">
            <a href="/" class="logo">
              <span class="logo__mark"><img src="/static/img/logo-symbol-white.webp" alt="정원한의원 심볼" width="30" height="44" /></span>
